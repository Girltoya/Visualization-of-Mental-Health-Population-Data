...
class MapUi(object):
    ...
    def setup_ui(self, Form):
        ...
        self.checkBox.setGeometry(QtCore.QRect(1230, 520, 161, 20))
    ...
    def combobox_overview_update_var(self):
        ...
        print(f"self.combobox_overview_var_init(diagnosis): {diagnosis}")
    ...
    def load_map(self, version, type, year, quarter, var):
        ...
        end_time = time.time()
        print(f'load map cost time: {end_time-start_time}ms')
    ...
    def load_charts(self, version, diagnosis, start_year, end_year):
        ...
        if tree_map is not None:
            map_path = f'{myMap.new_file_path}tree_map.html'
            ...
            self.map_widget.load(map_html)
        end_time = time.time()
        print(f'load chart cost time: {end_time - start_time}ms')
