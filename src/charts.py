...
# identify the map version
TREEMAP_NORMAL_VER = 0
TREEMAP_INCREASE_VER = 1


def treemap_html_file_name_get(new_file_path, version, diagnosis, start_year, end_year):
    """
    get the html file name of the generated treemap
    :param new_file_path: the path to save the new generated file
    :param version: TREEMAP_NORMAL_VER or TREEMAP_INCREASE_VER
    ...
    if diagnosis == DATASET_DIAGNOSIS_IAPT:
        file_name = new_file_path + 'iapt_treemap' + f'{start_year + 2019}_' \
                    + f'{end_year + 1}' + name_str + '.html'
    elif diagnosis == DATASET_DIAGNOSIS_CYPED:
        file_name = new_file_path + 'cyped_treemap' + f'{start_year + 2019}_' \
                    + f'{end_year + 1}' + name_str + '.html'
    elif diagnosis == DATASET_DIAGNOSIS_PHSMI:
        file_name = new_file_path + 'phsmi_treemap' + f'{start_year + 2019}_' \
                    + f'{end_year + 1}' + name_str + '.html'
    elif diagnosis == DATASET_DIAGNOSIS_OAPS:
        file_name = new_file_path + 'oaps_treemap' + f'{start_year + 2019}_' \
                    + f'{end_year + 1}' + name_str + '.html'
    return file_name
