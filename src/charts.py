...
def treemap_html_file_name_get(self, version, diagnosis, start_year, end_year):
    file_name = ''
    name_str = ''
    ...
    if diagnosis == DATASET_DIAGNOSIS_IAPT:
        file_name = self.new_file_path + 'iapt_treemap' + f'{start_year + 2019}_' \
                    + f'{end_year + 1}' + name_str + '.html'
    elif diagnosis == DATASET_DIAGNOSIS_CYPED:
        file_name = self.new_file_path + 'cyped_treemap' + f'{start_year + 2019}_' \
                    + f'{end_year + 1}' + name_str + '.html'
    elif diagnosis == DATASET_DIAGNOSIS_PHSMI:
        file_name = self.new_file_path + 'phsmi_treemap' + f'{start_year + 2019}_' \
                    + f'{end_year + 1}' + name_str + '.html'
    elif diagnosis == DATASET_DIAGNOSIS_OAPS:
        file_name = self.new_file_path + 'oaps_treemap' + f'{start_year + 2019}_' \
                    + f'{end_year + 1}' + name_str + '.html'
    return file_name
